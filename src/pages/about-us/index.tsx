...
export const AboutUs = () => {
  return (
    ...
    <div>
        ...
        realidad cubana, reduciendo los limites entre un emprendedor con ancias de exito y un mundo
        tecnologico dificil de tocar desde el interior de Cuba.
      </div>
      ...
      <div>
        Usted gestiona personalmente la estructura de sus paginas, administrando el que y como será
        visualizados sus publicaciones
      </div>
      <div>
